...
class App extends React.Component {
	constructor(props) {
		...
		this.pagePath = path.join(this.styleGuidePath, 'stacked', this.projectName, this.pageName + '.json');
		this.patternFactories = {};
	}

	render() {
		console.log('Requiring ' + this.pagePath);
	...
	createComponent(model) {
		...
		const patternSrc = path.join(this.styleGuidePath, 'lib', 'patterns', model.patternSrc, 'index.js');
