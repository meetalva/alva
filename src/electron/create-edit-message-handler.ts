					...
					case Types.ItemType.Element:
						injection.sender.send({
							...
							payload: {
								...
								project:
									ctx.project && ctx.project.getElementById(clipboard.payload.item.id)
										? undefined
										: clipboard.payload.project,
								targetType,
								targetId
							}
						});
					...
					case Types.ItemType.Page:
						injection.sender.send({
							...
							payload: {
								...
								project:
									ctx.project && ctx.project.getPageById(clipboard.payload.item.id)
										? undefined
										: clipboard.payload.project
							}
						});
